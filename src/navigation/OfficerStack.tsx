...
export const OfficerStack = () => {
  return (
    ...
    >
      ...
      <Stack.Screen
        name="PassportPreparation"
        component={PassportPreparationScreen}
      />
      ...
      <Stack.Screen
        ...
        component={FaceVerificationResultScreen}
      />
      ...
      {/* Offline Verification / Synchronization */}
      <Stack.Screen
        name="OfflineSync"
