 ...
 * 2. Dynamic Expo Metro connection: automatically extracts computer IP from Metro Bundler
 * 3. Web browser: auto-detect current hostname
...
const getBaseUrl = (): string => {
  ...
  // 2. Dynamic Expo host detection (extracts development PC IP from Metro connection)
  const hostUri =
